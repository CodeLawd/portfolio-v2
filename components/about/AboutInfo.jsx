    ...
    >
      ...
      <div className="w-full md:w-full mx-auto sticky top-24 group cursor-pointer">
        ...
        <img
          src="/joshua.jpg"
          alt="joshua alexander"
          className="block md:hidden rounded-md grayscale-0 group-hover:grayscale w-full h-[90%] object-cover object-top sticky z-10 group-hover:scale-110 transition-all duration-500"
        />
        <div className="border-2 border-secondary grayscale-0 transition-all duration-150 group-hover:grayscale group-hover:top-3 group-hover:-right-3  w-full h-full rounded-md absolute top-4 -right-4"></div>
      </div>
    </motion.div>
  );
};
